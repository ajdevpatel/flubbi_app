    ...
    <div class="row">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 mt-3"> GST Report </h4>
                        ...
                        <div class="col-12">
                            <div class="input-group input-daterange" id="from-to-date">
                                <input type="date" id="fdate_two" placeholder="MM/DD/YYYY" class="form-control"
                                    value="@php
echo config("web.webapp.filter_from_date"); @endphp" />
                                <span class="input-group-text">To</span>
                                <input type="date" id="tdate_two" placeholder="MM/DD/YYYY" class="form-control"
                                    value="@php
echo config("web.webapp.filter_to_date"); @endphp" />
            ...
            <table class="datatables-ajax table ajax_table" id="ajax_report_gst_datatables"
                data-url="{{ route('_gstReportIndex') }}">
                <thead>
                    <tr>
                        <th>Index</th>
                        <th>Date</th>
...
@section('jsIndex')
    ...
    <script src="{{ asset('appassets/layout/reportsIndex.js') }}"></script>
@endsection
